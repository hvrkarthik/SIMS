			...
			<div class="span12">
				<div class="widget-block">
				  <div class="widget-head">
						<h5><a href="student_master.php">Add New </a></h5>
...
$i=0; 
 ...
 $sql="select * from student_master sm, course c where sm.course_id=c.course_id and sm.course_id='$course_id' and sm.semester='$sem'";
 $res=mysql_query($sql);
 ...
 ?>
  <tr>
	...
	<td><a onClick="return confirm ('Are you sure....?')" href="student_master_delete.php?id=<?php echo $row['stud_id']; ?>">DELETE <img src="img/delete.png"></a></td>
