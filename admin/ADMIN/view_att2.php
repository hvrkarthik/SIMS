...
<title>Attendance View All</title>
<script>
...
<?php
    $sql1 = "select * from student_master st,student_subject ss where st.course_id='$course_id' and st.semester ='$sem' and st.stud_id=ss.stud_id and ss.subject_id='$subject_id'";
			//echo $sql1;
...
<tr <?php if($sino%2==0) echo 'bgcolor="#E4EEE5"';?>>
	...
	<?php 
		echo $sql2 = "select * from attendance a,course_subject cs where a.stud_id = ".$row1['stud_id']." and cs.course_id='$course_id' and cs.semester ='$sem' and a.cs_id='$cs_id' and a.date like '$year-$mon-%' order by a.date asc";
