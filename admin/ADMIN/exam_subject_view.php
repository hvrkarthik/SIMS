 ...
 ?>
  <tr>
	...
	<td><?php echo $row['semester']; ?></td>
	 ...
	 <br/><a href="add_marks.php?es_id=<?php echo $row['es_id']; ?>">Add MARKS</a></td>
	<td><a onClick="return confirm ('Are you sure....?')" href="exam_subject_delete.php?id=<?php echo $row['es_id']; ?>">DELETE<img src="img/delete.png"></a></td>
     </tr>
  <?php
  }
  ?>
